...
class botcontroller extends Controller
{
        ...
        public function testBOT()
        {
            ...
            "message": {
                ...
                "photo": [
                    {
                        "file_id": "AgACAgIAAxkBAAIJNWOm9hvI4O3sBWbm_nMvaEe5je2nAALJxDEbOVI5SXrdO-7Ov4JzAQADAgADcwADLAQ",
                        "file_unique_id": "AQADycQxGzlSOUl4",
                        "file_size": 1431,
                        "width": 65,
                        "height": 90
                    },
                    {
                        "file_id": "AgACAgIAAxkBAAIJNWOm9hvI4O3sBWbm_nMvaEe5je2nAALJxDEbOVI5SXrdO-7Ov4JzAQADAgADbQADLAQ",
                        "file_unique_id": "AQADycQxGzlSOUly",
                        "file_size": 16219,
                        "width": 231,
                        "height": 320
                    },
                    {
                        "file_id": "AgACAgIAAxkBAAIJNWOm9hvI4O3sBWbm_nMvaEe5je2nAALJxDEbOVI5SXrdO-7Ov4JzAQADAgADeAADLAQ",
                        "file_unique_id": "AQADycQxGzlSOUl9",
                        "file_size": 46637,
                        "width": 564,
                        "height": 780
                    }
...
Для этого и был создан канал GETLET https://t.me/getlet, в первую очередь для взаимопомощи между земляками из Республики Саха (Якутия), а также как возможность получить дополнительный заработок'
            ...
            if (isset($update->callback_query)) {
                ...
                $data2 = [
                    'chat_id' => $update->result->callback_query->from->id,
                    'text' => 'Ошибка еще хуже',
                ];
                $response = Http::get("https://api.telegram.org/bot5716304295:AAHVDPCzodAQOwQU5G-7kLfRUU7AVa2VTRg/sendMessage?" . http_build_query($data2));
            }
